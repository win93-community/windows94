    ...
    var b = {
        ...
        .createElement(
            ...
            f.className =
                "ui_progress__bar",
                e.className =
                "skin_inset_deep h20p mt5 relative ui_progress";
            var g = document
                .createElement(
                    "div"),
                h = document
                ...
                update: function (
                    ...
                    a = ~~a, i
                        .changeTitle(
                            ...
                            c),
                        f.style
                            .width = a + "%", 100 <= a && i.close()
                },
                win: i
            }
        },
        d = a => {
            a.el.base.style.zIndex =
                100000011, a.el.base
                    .style.boxShadow =
                "rgb(0, 0, 0) 1px 0px 0px 0px, rgb(0, 0, 0) 0px 1px 0px 0px, rgb(0, 0, 0) 1px 1px 0px 0px, rgb(255, 255, 255) 1px 1px 0px 0px inset, rgba(0, 0, 0, 0.5) 0px 0px 1px 1px",
                a.el.header.style
                    .background =
            ...
            onok: () => {
                var a =
                    c("Extracting files...",
                                                ...
                                                b ?
                                                    void (
                                                        a
                                                            .win
                                                            .innerHTML =
                                                        "An error occured, contact its-pablo#4477 on discord"
                                                    ) :
                                                    void JSZip
                                                        .loadAsync(
                                                            c
                        ...
                        onclose: () => {
                            var a =
                                c("<span id=\"rbda\">Rebooting in 5...</span>",
                                    "Rebooting...", {
                                    onclose: () => {
                                        setTimeout
                                            (() => {
